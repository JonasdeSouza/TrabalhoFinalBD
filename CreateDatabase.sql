...
CREATE TABLE IF NOT EXISTS `mydb`.`TipoEndereco` (
  ...
  `descricao` VARCHAR(45) NOT NULL COMMENT 'Descrição do tipo do endereço\nResidencial ou Comercial.',
  PRIMARY KEY (`idTipoEndereco`),
  UNIQUE INDEX `idTipoEndereco_UNIQUE` (`idTipoEndereco` ASC) VISIBLE,
  UNIQUE INDEX `descricao_UNIQUE` (`descricao` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 1;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Pessoa` (
  ...
  `matricula` INT(9) NULL COMMENT 'Matricula da pessoa na instituição',
  ...
  `Departamento_idDepartamento` INT NULL COMMENT '<>',
  ...
  INDEX `fk_Pessoa_Departamento1_idx` (`Departamento_idDepartamento` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Pessoa_Endereco1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Pessoa_Departamento1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`Fluxo` (
  ...
  INDEX `fk_Fluxo_Pessoa1_idx` (`Pessoa_idPessoa` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Disciplina` (
  ...
  UNIQUE INDEX `nome_UNIQUE` (`nome` ASC) VISIBLE,
  INDEX `fk_Disciplina_Departamento1_idx` (`Departamento_idDepartamento` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `mydb`.`Semestre_has_Disciplina`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Semestre_has_Disciplina` (
  `Semestre_idSemestre` INT NOT NULL,
  `Disciplina_idDisciplina` INT NOT NULL,
  `Mencao_idMencao` INT NULL,
  PRIMARY KEY (`Semestre_idSemestre`, `Disciplina_idDisciplina`),
  INDEX `fk_Semestre_has_Disciplina_Disciplina1_idx` (`Disciplina_idDisciplina` ASC) VISIBLE,
  INDEX `fk_Semestre_has_Disciplina_Semestre1_idx` (`Semestre_idSemestre` ASC) VISIBLE,
  INDEX `fk_Semestre_has_Disciplina_Mencao1_idx` (`Mencao_idMencao` ASC) VISIBLE,
  CONSTRAINT `fk_Semestre_has_Disciplina_Semestre1`
    FOREIGN KEY (`Semestre_idSemestre`)
    REFERENCES `mydb`.`Semestre` (`idSemestre`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Semestre_has_Disciplina_Disciplina1`
    FOREIGN KEY (`Disciplina_idDisciplina`)
    REFERENCES `mydb`.`Disciplina` (`idDisciplina`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Semestre_has_Disciplina_Mencao1`
